     ...
     <table class="w-full">
        ...
        <thead>
            <tr class="bg-blue-600 h-5">
                ...
                <th class="border-2 border-rose-500 w-3/12">Alamat</th>
        ...
        <tbody class="text-center">
            ...
            <tr>
                ...
                <td td class="text-justify border-2 border-rose-500 px-2.5">{{$output->jabatan_karyawan}}</p></td>
            </tr>
            @endforeach
     </table>
